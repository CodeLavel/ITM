      ...
      <div class="col-xl-12">
          <div class="card m-b-30">
              <div class="card-body">
                ...
                <h2>รายการครุภัณฑ์คืนแล้ว</h2>
                <a href="{{URL('orders/pdf3')}}" class="btn btn-danger" style="float:right; margin-bottom: 20px;"><i class="fa fa-print"> พิมพ์รายงาน</i></a>
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      @foreach($ordersuccess as $key => $logs)
                      <tr>
                        <td><h5>{{$key + 1}}</h5></td>
